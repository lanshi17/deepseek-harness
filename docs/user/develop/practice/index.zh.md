...
import { MyCapService, type MyCapRequest, type MyCapResult } from '@lanshi17/dsh-my-cap'
...
```yaml
- name: '@lanshi17/dsh-my-cap-local'
- name: '@lanshi17/dsh-tool-my-cap'
```
