...
- `packages/*` (except agent-loop's own tests and examples/) must not import `@lanshi17/dsh-agent-loop`.
- No cross-package deep imports (`@lanshi17/dsh-*/src/...` paths) — public entry points only.
