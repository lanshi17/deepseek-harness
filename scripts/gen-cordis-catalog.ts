...
import {
  ...
  REGION_BEGIN,
  REGION_END,
} from '@lanshi17/dsh-typert-generator'
import type { CordisCatalogPolicy } from '@lanshi17/dsh-typert-generator'
 ...
 * The scan that enforces this list reads EVERY `declare module '@lanshi17/cordis'`
 ...
 * scan reads EVERY `declare module '@lanshi17/cordis'` Events merge under
