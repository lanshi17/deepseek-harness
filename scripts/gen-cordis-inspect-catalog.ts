...
import type { CordisCatalogModel, ServiceMethodEntry } from '@lanshi17/dsh-typert-generator'
...
function main(): void {
  ...
  const source = projector.renderRuntimeApi(clientModel(model))
    .replaceAll('@lanshi17/dsh-tool-cordis/api-catalog', '@lanshi17/dsh-cordis-client-runner/client/api-catalog')
