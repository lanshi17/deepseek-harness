/** JSON string-prefix accounting for the outer-output ledger. @module @lanshi17/dsh-code-runtime-worker-thread/output-json */

import type { CodeJsonValue } from '@lanshi17/dsh-code-runtime'
