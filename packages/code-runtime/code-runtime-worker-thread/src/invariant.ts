/**
 * Package-owned invariant companion for `@lanshi17/dsh-code-runtime-worker-thread`.
 * @module @lanshi17/dsh-code-runtime-worker-thread/invariant
 */
...
const PACKAGE_NAME = '@lanshi17/dsh-code-runtime-worker-thread'
