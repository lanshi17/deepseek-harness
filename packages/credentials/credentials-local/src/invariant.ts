/**
 * Package-owned invariant companion for `@lanshi17/dsh-credentials-local`.
 * @module @lanshi17/dsh-credentials-local/invariant
 */
...
const PACKAGE_NAME = '@lanshi17/dsh-credentials-local'
