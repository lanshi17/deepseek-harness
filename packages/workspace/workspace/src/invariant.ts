/**
 * Package-owned invariant companion for `@lanshi17/dsh-workspace`.
 * @module @lanshi17/dsh-workspace/invariant
 */
...
import { WorkspaceId } from '@lanshi17/dsh-workspace'

const PACKAGE_NAME = '@lanshi17/dsh-workspace'
