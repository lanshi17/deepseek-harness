/**
 * Package-owned invariant companion for `@lanshi17/dsh-client-ui-attachment`.
 * @module @lanshi17/dsh-client-ui-attachment/invariant
 */
...
const PACKAGE_NAME = '@lanshi17/dsh-client-ui-attachment'
