/**
 * Package-owned invariant companion for `@lanshi17/dsh-client-modules`.
 * @module @lanshi17/dsh-client-modules/invariant
 */
...
const PACKAGE_NAME = '@lanshi17/dsh-client-modules'
