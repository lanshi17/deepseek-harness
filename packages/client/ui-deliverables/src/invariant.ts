/**
 * Package-owned invariant companion for `@lanshi17/dsh-client-ui-deliverables`.
 * @module @lanshi17/dsh-client-ui-deliverables/invariant
 */
...
const PACKAGE_NAME = '@lanshi17/dsh-client-ui-deliverables'
