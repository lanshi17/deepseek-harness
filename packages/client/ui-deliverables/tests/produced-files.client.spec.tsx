...
import type { ChatFileMentions, TurnTailOwnerProps } from '@lanshi17/dsh-client-ui-conversation/client'
import { makeTranslate, stubSettingsScope } from '@lanshi17/dsh-client-test-runtime'
import {
...
describe('package shells', () => {
  it('the invariant companion registers ownership', async () => {
    ...
    expect(registered).toEqual(['@lanshi17/dsh-client-ui-deliverables'])
