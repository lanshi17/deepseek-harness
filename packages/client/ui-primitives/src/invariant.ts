/**
 * Package-owned invariant companion for `@lanshi17/dsh-client-ui-primitives`.
 * @module @lanshi17/dsh-client-ui-primitives/invariant
 */
...
const PACKAGE_NAME = '@lanshi17/dsh-client-ui-primitives'
