/**
 * Package-owned invariant companion for `@lanshi17/dsh-client-ui-message-feedback`.
 * @module @lanshi17/dsh-client-ui-message-feedback/invariant
 */
...
const PACKAGE_NAME = '@lanshi17/dsh-client-ui-message-feedback'
