/**
 * Package-owned invariant companion for `@lanshi17/dsh-client-ui-settings-general`.
 * @module @lanshi17/dsh-client-ui-settings-general/invariant
 */
...
const PACKAGE_NAME = '@lanshi17/dsh-client-ui-settings-general'
