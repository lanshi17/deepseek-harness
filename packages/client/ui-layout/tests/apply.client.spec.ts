...
import { LocaleRuntime } from '@lanshi17/dsh-client-locale/client'
import { apply as themeApply, inject as themeInject, ThemeRuntime } from '@lanshi17/dsh-client-ui-theme/client'
import { apply, inject, LayoutController } from '@lanshi17/dsh-client-ui-layout/client'
import { apply as nodeApply } from '@lanshi17/dsh-client-ui-layout'
import * as invariant from '@lanshi17/dsh-client-ui-layout/invariant'
...
describe('node half + invariant companion', () => {
  ...
  it('invariant companion registers under the package name', async () => {
    ...
    expect(register).toHaveBeenCalledWith('@lanshi17/dsh-client-ui-layout', expect.any(Function))
