...
import type { ThemeSnapshot } from '@lanshi17/dsh-client-ui-theme/client'
import { DARK_ATTRIBUTE, ThemePresenter } from '@lanshi17/dsh-client-ui-layout/src/client/theme-presenter.ts'
