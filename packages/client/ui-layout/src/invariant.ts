/**
 * Package-owned invariant companion for `@lanshi17/dsh-client-ui-layout`.
 * @module @lanshi17/dsh-client-ui-layout/invariant
 */
...
const PACKAGE_NAME = '@lanshi17/dsh-client-ui-layout'
