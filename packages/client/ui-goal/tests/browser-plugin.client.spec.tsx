...
import { ConversationEventRegistry } from '@lanshi17/dsh-client-runtime/src/client/conversation/event-registry.ts'
import type { GoalProjection } from '@lanshi17/dsh-goal/client'
