/**
 * Package-owned invariant companion for `@lanshi17/dsh-client-ui-goal`.
 * @module @lanshi17/dsh-client-ui-goal/invariant
 */
...
const PACKAGE_NAME = '@lanshi17/dsh-client-ui-goal'
