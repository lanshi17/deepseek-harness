/**
 * Package-owned invariant companion for `@lanshi17/dsh-client-ui-user-questions`.
 * @module @lanshi17/dsh-client-ui-user-questions/invariant
 */
...
const PACKAGE_NAME = '@lanshi17/dsh-client-ui-user-questions'
