/**
 * Package-owned invariant companion for `@lanshi17/dsh-client-ui-directory-picker-native`.
 * @module @lanshi17/dsh-client-ui-directory-picker-native/invariant
 */
...
const PACKAGE_NAME = '@lanshi17/dsh-client-ui-directory-picker-native'
