/**
 * Package-owned invariant companion for `@lanshi17/dsh-client-web-react`.
 * @module @lanshi17/dsh-client-web-react/invariant
 */
...
const PACKAGE_NAME = '@lanshi17/dsh-client-web-react'
