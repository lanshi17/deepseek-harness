/**
 * Package-owned invariant companion for `@lanshi17/dsh-client-ui-settings-models`.
 * @module @lanshi17/dsh-client-ui-settings-models/invariant
 */
...
const PACKAGE_NAME = '@lanshi17/dsh-client-ui-settings-models'
