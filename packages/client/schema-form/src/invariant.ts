/**
 * Package-owned invariant companion for `@lanshi17/dsh-client-schema-form`.
 * @module @lanshi17/dsh-client-schema-form/invariant
 */
...
const PACKAGE_NAME = '@lanshi17/dsh-client-schema-form'
