...
import type { ConnectionHandle, SessionId } from '@lanshi17/dsh-api-remotes/client'
...
import type { TypertContext } from '@lanshi17/dsh-typert-protocol'
import type { MaybeSnapshotSelectorHook, SnapshotSelectorHook } from '@lanshi17/dsh-client-ui-slots'
...
export { isAppendSurfaceEvent, isReplacementSurfaceEvent } from '@lanshi17/dsh-session/surface'
...
export type { SubagentAddress, JobView } from '@lanshi17/dsh-client-connection/client'
...
export type { SessionId } from '@lanshi17/dsh-client-connection/client'
...
declare module '@lanshi17/dsh-client-ui-slots' {
  /**
