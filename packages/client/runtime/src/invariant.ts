/**
 * Package-owned invariant companion for `@lanshi17/dsh-client-runtime`.
 * @module @lanshi17/dsh-client-runtime/invariant
 */
...
import type { SlotMap } from '@lanshi17/dsh-client-ui-slots'
import type { InvariantInstaller } from '@lanshi17/dsh-invariants'

const PACKAGE_NAME = '@lanshi17/dsh-client-runtime'
