/**
 * Package-owned invariant companion for `@lanshi17/dsh-client-ui-model-selection`.
 * @module @lanshi17/dsh-client-ui-model-selection/invariant
 */
...
const PACKAGE_NAME = '@lanshi17/dsh-client-ui-model-selection'
