...
import type { ModelSelection, SessionModels } from '@lanshi17/dsh-api-remotes/client'
import type { ClientContext } from '@lanshi17/dsh-client-runtime/client'
import type { CommandUiContract, SelectOption } from '@lanshi17/dsh-client-ui-commands/client'
// Type-only: pulls the ui-conversation SlotMap merge (the input.model seat).
import type {} from '@lanshi17/dsh-client-ui-conversation/client'
// Type-only: pulls the locale plugin's Context merge (ctx.locale).
import type {} from '@lanshi17/dsh-client-locale/client'
import type { TranslateNS } from '@lanshi17/dsh-client-ui-slots'
