...
import { usePinnedBrowserLanguages } from '@lanshi17/dsh-client-test-runtime'
import { createScope, scopeOf, SlotRegistry } from '@lanshi17/dsh-client-runtime/client'
import type { SessionId } from '@lanshi17/dsh-client-runtime/client'
import { apply, inject, InputTriggerService } from '@lanshi17/dsh-client-ui-input-trigger/client'
import type { MenuViewInjected } from '@lanshi17/dsh-client-ui-input-trigger/client'
