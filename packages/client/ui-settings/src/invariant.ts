/**
 * Package-owned invariant companion for `@lanshi17/dsh-client-ui-settings`.
 * @module @lanshi17/dsh-client-ui-settings/invariant
 */
...
const PACKAGE_NAME = '@lanshi17/dsh-client-ui-settings'
