 ...
 * not built (`pnpm --filter @lanshi17/dsh-client-ui-trajectory bundle`).
 */
...
const PLUGIN_ID = '@lanshi17/dsh-client-ui-trajectory'
...
describe('tsdown client artifact', () => {
  ...
  async function loadArtifact() {
    ...
    const modules = new Map<string, unknown>([
      ...
      ['@lanshi17/dsh-client-runtime/client', await import('@lanshi17/dsh-client-runtime/client')],
      ['@lanshi17/dsh-client-ui-primitives', await import('@lanshi17/dsh-client-ui-primitives')],
    ])
  ...
  it.skipIf(code === undefined)('mounted as an object plugin, apply registers the view tab on the real ring', async () => {
    ...
    const locale = await import('@lanshi17/dsh-client-locale/client')
