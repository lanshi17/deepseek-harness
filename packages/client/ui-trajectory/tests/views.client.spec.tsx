...
import { resolveSlotLabel } from '@lanshi17/dsh-client-ui-slots'
import {
  ConversationEventRegistry, ConversationViewRegistry, createSnapshotStore,
  EMPTY_CHAT_SNAPSHOT,
} from '@lanshi17/dsh-client-runtime/client'
import { SlotRegistry } from '@lanshi17/dsh-client-runtime/client'
import type {
  ConversationSnapshot, RequestView,
  SessionId, SessionListState, SnapshotStore, WorkspaceListState,
} from '@lanshi17/dsh-client-runtime/client'
import type { ConvViewProps, ViewTab } from '@lanshi17/dsh-client-ui-conversation/client'
import {
  ConversationSession, ConversationSessionHeader,
  type ConversationSessionHeaderProps, type ConversationSessionProps,
} from '@lanshi17/dsh-client-ui-conversation/src/client/skeleton/ConversationSession.tsx'
import { createChatStore } from '@lanshi17/dsh-client-ui-conversation/src/client/stores.ts'
import { zh as conversationZh } from '@lanshi17/dsh-client-ui-conversation/src/client/locales.ts'
import { apply as localeApply, inject as localeInject } from '@lanshi17/dsh-client-locale/client'
import { stubSettingsScope } from '@lanshi17/dsh-client-test-runtime'
import type { LocaleKeysOf } from '@lanshi17/dsh-client-ui-slots'
import { zh, type TrajectoryKey } from '../src/client/locales.ts'
import { apply, inject } from '@lanshi17/dsh-client-ui-trajectory/client'
import { apply as nodeApply } from '@lanshi17/dsh-client-ui-trajectory'
