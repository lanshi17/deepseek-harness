/**
 * Package-owned invariant companion for `@lanshi17/dsh-client-ui-trajectory`.
 * @module @lanshi17/dsh-client-ui-trajectory/invariant
 */
...
const PACKAGE_NAME = '@lanshi17/dsh-client-ui-trajectory'
