...
import type { ToolCallOwnerProps } from '@lanshi17/dsh-client-ui-tool/client'
import { IconGlobeOutline14 } from '@lanshi17/dsh-client-ui-primitives'
...
describe('web toolview registration', () => {
  it('registers one WebRow under both web_search and web_fetch', () => {
    ...
    } as unknown as import('@lanshi17/cordis').Context
