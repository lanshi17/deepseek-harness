...
import type { ISession, SessionId, ToolResultNode } from '@lanshi17/dsh-client-runtime/client'
import type { PropsRenderSlots } from '@lanshi17/dsh-client-ui-slots'
import { SlotTestRuntime, stubSettingsScope } from '@lanshi17/dsh-client-test-runtime'
import { LocaleRuntime } from '@lanshi17/dsh-client-locale/client'
import { apply as applyConversation, inject as injectConversation } from '@lanshi17/dsh-client-ui-conversation/client'
import { apply as applyTool, inject as injectTool } from '@lanshi17/dsh-client-ui-tool/client'
import type { ToolCallViewProps } from '@lanshi17/dsh-client-ui-tool/client'
