...
import type { SessionProviderComponent, TranslateNS } from '@lanshi17/dsh-client-ui-slots'
import type { DetailsSlotProps, DetailsToolOwnerProps } from '@lanshi17/dsh-client-ui-conversation/src/client/contract/slots.ts'
