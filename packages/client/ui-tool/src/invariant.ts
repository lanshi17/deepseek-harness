/**
 * Package-owned invariant companion for `@lanshi17/dsh-client-ui-tool`.
 * @module @lanshi17/dsh-client-ui-tool/invariant
 */
...
const PACKAGE_NAME = '@lanshi17/dsh-client-ui-tool'
