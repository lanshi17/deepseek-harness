 ...
 * @module
 */
import { resolveWorkspacePath } from '@lanshi17/dsh-client-runtime/client'
import type { TerminalBlockLabels, TerminalBlockProps } from '@lanshi17/dsh-client-ui-primitives'
