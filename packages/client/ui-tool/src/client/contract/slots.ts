...
import type { PropsLocale, PropsRenderSlots, PropsRuntime } from '@lanshi17/dsh-client-ui-slots'
import type { ToolCallBlock } from '@lanshi17/dsh-client-runtime/client'
