/**
 * Package-owned invariant companion for `@lanshi17/dsh-client-ui-subagent`.
 * @module @lanshi17/dsh-client-ui-subagent/invariant
 */
...
const PACKAGE_NAME = '@lanshi17/dsh-client-ui-subagent'
