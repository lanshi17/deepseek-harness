 ...
 */
import type { ConnectionHandle } from '@lanshi17/dsh-api-remotes/client'
// Type-only: pulls the locale plugin's Context merge (ctx.locale).
import type {} from '@lanshi17/dsh-client-locale/client'
// Type-only: the settings slot types (this package registers a General row).
import type {} from '@lanshi17/dsh-client-ui-settings/client'
// Type-only: pulls the ctx.remote merge and the forwarded-event key face
// (the settings invalidation rides the allowlist) into this program.
import type {} from '@lanshi17/dsh-api-remotes/client'
import type { ClientContext, SessionFace } from '@lanshi17/dsh-client-runtime/client'
import type { CommandUiContract, SelectOption } from '@lanshi17/dsh-client-ui-commands/client'
import type { ClientSessionContext } from '@lanshi17/dsh-client-ui-input-trigger/client'
import type { PermissionSelect } from '@lanshi17/dsh-permission-presets/client'
