...
import { hostFrameSchema, muxFrameSchema } from '@lanshi17/dsh-host-apiproxy/api/events.schema'
import { serverRequestSchema } from '@lanshi17/dsh-host-apiproxy/api/rpc.schema'
