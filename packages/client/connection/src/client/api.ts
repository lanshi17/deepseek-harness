...
export { AbstractApiClient } from '@lanshi17/dsh-host-apiproxy/client'
export type { IApiClient } from '@lanshi17/dsh-host-apiproxy/client'
export type { SessionId, SessionEvent } from '@lanshi17/dsh-session/types'
export type { MessageId } from '@lanshi17/dsh-llm/brand'
export type { ContentBlock, StreamChunk } from '@lanshi17/dsh-llm/types'

/** Successful value returned by the connection-generation host handshake. */
export type HostDescription = import('@lanshi17/dsh-host-apiproxy/api').ResponseValue<'host.describe'>

import type { RpcResponse, RpcResult } from '@lanshi17/dsh-host-apiproxy/api'
