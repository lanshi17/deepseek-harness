/**
 * Package-owned invariant companion for `@lanshi17/dsh-client-ui-agent-preset`.
 * @module @lanshi17/dsh-client-ui-agent-preset/invariant
 */
...
const PACKAGE_NAME = '@lanshi17/dsh-client-ui-agent-preset'
