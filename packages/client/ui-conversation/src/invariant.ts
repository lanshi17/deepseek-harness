/**
 * Package-owned invariant companion for `@lanshi17/dsh-client-ui-conversation`.
 * @module @lanshi17/dsh-client-ui-conversation/invariant
 */
...
const PACKAGE_NAME = '@lanshi17/dsh-client-ui-conversation'
