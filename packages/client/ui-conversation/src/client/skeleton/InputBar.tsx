...
} from '@lanshi17/dsh-client-ui-primitives'
import { AttachmentRail, DropOverlay, ImageLightbox } from '@lanshi17/dsh-client-ui-attachment'
import type { AttachmentRailItem } from '@lanshi17/dsh-client-ui-attachment'
// Type-only: the `plan` projection key merge (the TodoDock posture — the
// composer reads a host-computed value; the domain owns the key).
import type {} from '@lanshi17/dsh-plan-mode/client'
// Type-only: the `goal` projection key merge (hint disambiguation).
import type {} from '@lanshi17/dsh-goal/client'
...
import type { Translate } from '@lanshi17/dsh-client-ui-slots'
