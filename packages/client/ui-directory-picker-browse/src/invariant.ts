/**
 * Package-owned invariant companion for `@lanshi17/dsh-client-ui-directory-picker-browse`.
 * @module @lanshi17/dsh-client-ui-directory-picker-browse/invariant
 */
...
const PACKAGE_NAME = '@lanshi17/dsh-client-ui-directory-picker-browse'
