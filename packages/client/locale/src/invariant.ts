/**
 * Package-owned invariant companion for `@lanshi17/dsh-client-locale`.
 * @module @lanshi17/dsh-client-locale/invariant
 */
...
const PACKAGE_NAME = '@lanshi17/dsh-client-locale'
