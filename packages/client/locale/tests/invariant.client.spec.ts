...
import { apply as nodeApply } from '@lanshi17/dsh-client-locale'
import { apply as clientApply, COMMON_NS, LocaleRuntime, inject } from '@lanshi17/dsh-client-locale/client'
import * as LocaleInvariant from '@lanshi17/dsh-client-locale/invariant'
