...
import { stubSettingsScope, type StubSettingsScope } from '@lanshi17/dsh-client-test-runtime'
import type { LocaleSettings, LocaleSnapshot } from '@lanshi17/dsh-client-locale/client'
