/**
 * Package-owned invariant companion for `@lanshi17/dsh-client-ui-plan`.
 * @module @lanshi17/dsh-client-ui-plan/invariant
 */
...
const PACKAGE_NAME = '@lanshi17/dsh-client-ui-plan'
