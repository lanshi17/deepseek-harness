...
import { TestRemote, usePinnedBrowserLanguages } from '@lanshi17/dsh-client-test-runtime'
import { SettingsScopeBinder } from '@lanshi17/dsh-client-ui-settings/client'
import { apply, inject } from '@lanshi17/dsh-client-ui-settings-plugins/client'
import type {
  ConfigurablePluginsTabInjected, PluginsSettingsSectionInjected,
} from '@lanshi17/dsh-client-ui-settings-plugins/client'
