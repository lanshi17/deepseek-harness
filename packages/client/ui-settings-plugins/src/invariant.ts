/**
 * Package-owned invariant companion for `@lanshi17/dsh-client-ui-settings-plugins`.
 * @module @lanshi17/dsh-client-ui-settings-plugins/invariant
 */
...
const PACKAGE_NAME = '@lanshi17/dsh-client-ui-settings-plugins'
