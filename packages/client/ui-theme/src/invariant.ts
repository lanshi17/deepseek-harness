/**
 * Package-owned invariant companion for `@lanshi17/dsh-client-ui-theme`.
 * @module @lanshi17/dsh-client-ui-theme/invariant
 */
...
const PACKAGE_NAME = '@lanshi17/dsh-client-ui-theme'
