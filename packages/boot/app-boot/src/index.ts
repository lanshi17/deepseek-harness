...
import { Context, type FiberState } from '@lanshi17/cordis'
import Loader, { type Entry, type EntryOptions } from '@lanshi17/cordis-plugin-loader'
import Include, { applyEntryPatches, entryListSchema, type PatchOptions } from '@lanshi17/cordis-plugin-include'
import Group from '@lanshi17/cordis-plugin-group'
import { dshHomePath, resolveDshHome } from '@lanshi17/dsh-home-paths'
import { createLaunchEnvironmentSnapshot, type LaunchEnvironmentSnapshot } from '@lanshi17/dsh-launch-environment'
import type {} from '@lanshi17/cordis-plugin-hmr'
 ...
 * entries (`@lanshi17/cordis-plugin-include`'s `PatchOptions`): id-targeted config
 ...
 * `@lanshi17/cordis-plugin-include` `PatchOptions` (id-targeted config overrides and
...
export async function mountRootInclude(
  ...
  // preset living outside this workspace cannot resolve `@lanshi17/cordis-plugin-group`
