 ...
 * @module @lanshi17/dsh-app-boot/profile
 */
...
import { applyEntryPatches, type PatchOptions } from '@lanshi17/cordis-plugin-include'
...
export const PROFILE_TEMPLATES: Record<string, readonly string[]> = {
  web: ['@lanshi17/dsh-base', '@lanshi17/dsh-web-app'],
  headless: ['@lanshi17/dsh-base', '@lanshi17/dsh-headless'],
}

/** Installation-owned bundle tuples normalized to the shipped template. */
const INSTALLATION_OWNED_PROFILE_TUPLES: Record<string, readonly string[]> = {
  headless: ['@lanshi17/dsh-base', '@lanshi17/dsh-web-app', '@lanshi17/dsh-headless'],
}

/** The bundle list a `dsh plugin` init uses for a name with no shipped template. */
export const DEFAULT_PROFILE_BUNDLES: readonly string[] = ['@lanshi17/dsh-base']
 ...
 * `@lanshi17/dsh-base` (and every other in-box bundle) always comes from
