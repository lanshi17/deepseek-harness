...
import type { SaveTextSpill } from '@lanshi17/dsh-spill'
import LocalSpillStore, { encodeSegment, privateRoot, saveTextFile, sessionDir } from '@lanshi17/dsh-spill-local'
