/**
 * Package-owned invariant companion for `@lanshi17/dsh-storage-domain`: every
 ...
 * @module @lanshi17/dsh-storage-domain/invariant
 */
...
const PACKAGE_NAME = '@lanshi17/dsh-storage-domain'
