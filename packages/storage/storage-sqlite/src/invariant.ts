/**
 * Package-owned invariant companion for `@lanshi17/dsh-storage-sqlite`.
 * @module @lanshi17/dsh-storage-sqlite/invariant
 */
...
const PACKAGE_NAME = '@lanshi17/dsh-storage-sqlite'
