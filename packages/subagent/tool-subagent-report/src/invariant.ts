/**
 * Package-owned invariant companion for `@lanshi17/dsh-tool-subagent-report`.
 * @module @lanshi17/dsh-tool-subagent-report/invariant
 */
...
const PACKAGE_NAME = '@lanshi17/dsh-tool-subagent-report'
