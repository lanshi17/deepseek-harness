 ...
 * runtime over stdio JSON-RPC through `@lanshi17/dsh-sdk-client` and owns
 * cancellation and quiescent disposal. Structure mirrors the ACP backend
 * (`@lanshi17/dsh-subagent-acp`): publish after the child handshake,
 ...
 *
 * @module @lanshi17/dsh-subagent-dsh-sdk/run
 */

import { randomUUID } from 'node:crypto'
import { DeepSeekHarness, type HarnessNotification } from '@lanshi17/dsh-sdk-client'
import type { ContentBlock } from '@lanshi17/dsh-llm'
import { SessionId, type SessionEvent, type TurnEndReason } from '@lanshi17/dsh-session'
import type { SubagentResult, SubagentRun, SubagentStartRequest, SubagentStopReason } from '@lanshi17/dsh-subagent'
import { AssistantOutputFold, settleRunResult, subprocessRunHandle } from '@lanshi17/dsh-subagent'
import { scrubbedParentEnv } from '@lanshi17/dsh-subprocess'
