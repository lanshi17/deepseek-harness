/**
 * Package-owned invariant companion for `@lanshi17/dsh-subagent-dsh-sdk`.
 * @module @lanshi17/dsh-subagent-dsh-sdk/invariant
 */
...
const PACKAGE_NAME = '@lanshi17/dsh-subagent-dsh-sdk'
