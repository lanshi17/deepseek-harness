/**
 * Package-owned invariant companion for `@lanshi17/dsh-tool-subagent`.
 * @module @lanshi17/dsh-tool-subagent/invariant
 */
...
const PACKAGE_NAME = '@lanshi17/dsh-tool-subagent'
