 ...
 *
 * @module @lanshi17/dsh-subagent/types
 */

import type { Agent, AgentOptions } from '@lanshi17/dsh-agent'
...
import type { ObjectJsonSchema, ToolRestriction } from '@lanshi17/dsh-tools'
