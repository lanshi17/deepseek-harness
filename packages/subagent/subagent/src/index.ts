 ...
 * (`@lanshi17/dsh-subagent-spawn-in-process`, `-fork`, `-acp`) and the model-facing
 * consumer (`@lanshi17/dsh-tool-subagent`) are separate packages.
 *
...
import { assertObjectJsonSchema } from '@lanshi17/dsh-tools'
import type { ContentBlock, MessageId } from '@lanshi17/dsh-llm'
