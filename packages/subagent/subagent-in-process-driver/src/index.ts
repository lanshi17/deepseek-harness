 ...
 * one result.
 *
 * @module @lanshi17/dsh-subagent-in-process-driver
 */

import { randomUUID } from 'node:crypto'
import type { Context } from '@lanshi17/cordis'
import { foldConsumedWork } from '@lanshi17/dsh-agent'
...
import { createUserMessage, type ContentBlock } from '@lanshi17/dsh-llm'
import {
