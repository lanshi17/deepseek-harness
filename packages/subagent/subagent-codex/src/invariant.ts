/**
 * Package-owned invariant companion for `@lanshi17/dsh-subagent-codex`.
 * @module @lanshi17/dsh-subagent-codex/invariant
 */
...
const PACKAGE_NAME = '@lanshi17/dsh-subagent-codex'
