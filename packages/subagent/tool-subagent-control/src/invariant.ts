/**
 * Package-owned invariant companion for `@lanshi17/dsh-tool-subagent-control`.
 * @module @lanshi17/dsh-tool-subagent-control/invariant
 */
...
const PACKAGE_NAME = '@lanshi17/dsh-tool-subagent-control'
