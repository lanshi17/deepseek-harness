/**
 * Package-owned invariant companion for `@lanshi17/dsh-tool-terminal`.
 * @module @lanshi17/dsh-tool-terminal/invariant
 */
...
const PACKAGE_NAME = '@lanshi17/dsh-tool-terminal'
