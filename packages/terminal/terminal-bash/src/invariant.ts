/**
 * Package-owned invariant companion for `@lanshi17/dsh-terminal-bash`.
 * @module @lanshi17/dsh-terminal-bash/invariant
 */
...
const PACKAGE_NAME = '@lanshi17/dsh-terminal-bash'
