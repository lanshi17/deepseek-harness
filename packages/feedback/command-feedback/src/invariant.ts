/**
 * Package-owned invariant companion for `@lanshi17/dsh-command-feedback`.
 * @module @lanshi17/dsh-command-feedback/invariant
 */
...
const PACKAGE_NAME = '@lanshi17/dsh-command-feedback'
