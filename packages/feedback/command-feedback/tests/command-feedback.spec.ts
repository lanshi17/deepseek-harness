...
import SessionStore, { foldSurface, Session, SessionId } from '@lanshi17/dsh-session'
import { SessionTelemetryBackend, type SessionTelemetrySharingStatus } from '@lanshi17/dsh-session-telemetry'
import * as commandFeedback from '@lanshi17/dsh-command-feedback'
...
vi.mock('@lanshi17/dsh-anonymous-user-id', () => ({
...
describe('@lanshi17/dsh-command-feedback registration', () => {
