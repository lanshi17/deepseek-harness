/**
 * Package-owned invariant companion for `@lanshi17/dsh-sdk-jsonrpc-demo`.
 * @module @lanshi17/dsh-sdk-jsonrpc-demo/invariant
 */
...
const PACKAGE_NAME = '@lanshi17/dsh-sdk-jsonrpc-demo'
