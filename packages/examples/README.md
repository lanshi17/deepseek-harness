...
|---|---|---|
| [`agent-spine-demo/`](agent-spine-demo/README.md) | `@lanshi17/dsh-agent-spine-demo` | Reusable agent-spine bundle |
| [`acp-demo/`](acp-demo/README.md) | `@lanshi17/dsh-acp-demo` | ACP automation application bundle |
| [`jsonrpc-demo/`](jsonrpc-demo/README.md) | `@lanshi17/dsh-sdk-jsonrpc-demo` | External-config JSON-RPC runtime |
