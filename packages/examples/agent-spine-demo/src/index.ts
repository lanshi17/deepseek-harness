 ...
 * @module @lanshi17/dsh-agent-spine-demo
 */

import type { Context } from '@lanshi17/cordis'
import Timer from '@lanshi17/cordis-plugin-timer'
import z from '@lanshi17/schemastery'
import LlmRuntime from '@lanshi17/dsh-llm'
import SessionStore from '@lanshi17/dsh-session'
import SessionTitleService, { type Config as SessionTitleConfig } from '@lanshi17/dsh-session-title'
import SystemPrompt, { type Config as SystemPromptConfig } from '@lanshi17/dsh-system-prompt'
import ToolRuntime, { type Config as ToolsConfig } from '@lanshi17/dsh-tools'
import SkillRegistry, { type Config as SkillRegistryConfig } from '@lanshi17/dsh-skill'
import * as SkillFileSystem from '@lanshi17/dsh-skill-filesystem'
import AgentRegistry from '@lanshi17/dsh-agent'
import GoalService, { type Config as GoalDomainConfig } from '@lanshi17/dsh-goal'
import * as goalSession from '@lanshi17/dsh-goal-round-driver'
import * as toolGoal from '@lanshi17/dsh-tool-goal'
import LocalJobRegistry, { type Config as JobsConfig } from '@lanshi17/dsh-jobs-local'
import InvariantRegistry, { type Config as InvariantConfig } from '@lanshi17/dsh-invariants'
import * as sessionInvariant from '@lanshi17/dsh-session/invariant'
import * as agentInvariant from '@lanshi17/dsh-agent/invariant'
import * as scopeInvariant from '@lanshi17/dsh-scope/invariant'
import * as agentLoopInvariant from '@lanshi17/dsh-agent-loop/invariant'
import * as toolBash from '@lanshi17/dsh-tool-bash'
import * as bashEnv from '@lanshi17/dsh-shell-env'
import * as workspaceContext from '@lanshi17/dsh-agent-instructions'
import * as toolSkill from '@lanshi17/dsh-tool-skill'
import * as toolJobs from '@lanshi17/dsh-tool-jobs'
import AgentLoop, { type Config as AgentLoopConfig } from '@lanshi17/dsh-agent-loop'
import * as llmRetry from '@lanshi17/dsh-llm-retry'
import { resolveDshHome } from '@lanshi17/dsh-home-paths'
