/**
 * Package-owned invariant companion for `@lanshi17/dsh-agent-spine-demo`.
 * @module @lanshi17/dsh-agent-spine-demo/invariant
 */
...
const PACKAGE_NAME = '@lanshi17/dsh-agent-spine-demo'
