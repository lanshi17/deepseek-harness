/**
 * Package-owned invariant companion for `@lanshi17/dsh-typert-loader`.
 * @module @lanshi17/dsh-typert-loader/invariant
 */
...
const PACKAGE_NAME = '@lanshi17/dsh-typert-loader'
