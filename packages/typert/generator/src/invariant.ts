/**
 * Package-owned invariant companion for `@lanshi17/dsh-typert-generator`.
 * @module @lanshi17/dsh-typert-generator/invariant
 */
...
const PACKAGE_NAME = '@lanshi17/dsh-typert-generator'
