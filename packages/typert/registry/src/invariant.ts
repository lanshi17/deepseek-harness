/**
 * Package-owned invariant companion for `@lanshi17/dsh-typert-registry`.
 * @module @lanshi17/dsh-typert-registry/invariant
 */
...
const PACKAGE_NAME = '@lanshi17/dsh-typert-registry'
