 ...
 *
 * The seam itself lives in `@lanshi17/dsh-compaction`, which re-exports these
 ...
 *
 * @module @lanshi17/dsh-compaction/checkpoint
 */

import type { MessageSource } from '@lanshi17/dsh-llm/message'
