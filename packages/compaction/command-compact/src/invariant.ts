/**
 * Package-owned invariant companion for `@lanshi17/dsh-command-compact`.
 * @module @lanshi17/dsh-command-compact/invariant
 */
...
const PACKAGE_NAME = '@lanshi17/dsh-command-compact'
