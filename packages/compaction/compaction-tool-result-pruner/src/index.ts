 ...
 *
 * @module @lanshi17/dsh-compaction-tool-result-pruner
 */

import { Context, Service } from '@lanshi17/cordis'
import z from '@lanshi17/schemastery'
import { freezeMessage } from '@lanshi17/dsh-llm'
import type { ContentBlock } from '@lanshi17/dsh-llm'
import type { Session, SessionEvent, ToolResultMessage } from '@lanshi17/dsh-session'
// Type-only: the `compaction/*` SessionEventMap merges (the shadow-price event).
import type {} from '@lanshi17/dsh-compaction'
