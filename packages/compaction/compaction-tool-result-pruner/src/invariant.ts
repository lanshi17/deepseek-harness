/**
 * Package-owned invariant companion for `@lanshi17/dsh-compaction-tool-result-pruner`.
 * @module @lanshi17/dsh-compaction-tool-result-pruner/invariant
 */
...
const PACKAGE_NAME = '@lanshi17/dsh-compaction-tool-result-pruner'
