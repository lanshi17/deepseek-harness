/**
 * Package-owned invariant companion for `@lanshi17/dsh-llm-mock-server`.
 * @module @lanshi17/dsh-llm-mock-server/invariant
 */
...
const PACKAGE_NAME = '@lanshi17/dsh-llm-mock-server'
