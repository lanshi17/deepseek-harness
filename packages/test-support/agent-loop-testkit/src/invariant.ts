/**
 * Package-owned invariant companion for `@lanshi17/dsh-agent-loop-testkit`.
 * @module @lanshi17/dsh-agent-loop-testkit/invariant
 */
...
const PACKAGE_NAME = '@lanshi17/dsh-agent-loop-testkit'
