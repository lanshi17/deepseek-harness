/**
 * Package-owned invariant companion for `@lanshi17/dsh-client-test-runtime`.
 * @module @lanshi17/dsh-client-test-runtime/invariant
 */
...
const PACKAGE_NAME = '@lanshi17/dsh-client-test-runtime'
