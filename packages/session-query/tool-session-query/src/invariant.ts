/**
 * Package-owned invariant companion for `@lanshi17/dsh-tool-session-query`.
 * @module @lanshi17/dsh-tool-session-query/invariant
 */
...
const PACKAGE_NAME = '@lanshi17/dsh-tool-session-query'
