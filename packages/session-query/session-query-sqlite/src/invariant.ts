/**
 * Package-owned invariant companion for `@lanshi17/dsh-session-query-sqlite`.
 * @module @lanshi17/dsh-session-query-sqlite/invariant
 */
...
const PACKAGE_NAME = '@lanshi17/dsh-session-query-sqlite'
