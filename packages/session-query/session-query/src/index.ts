 ...
 *
 * @module @lanshi17/dsh-session-query
 */

import { Context, Service } from '@lanshi17/cordis'
import { Session, snapshotSessionEvent, type SessionId } from '@lanshi17/dsh-session'
import { foldSessionTitle } from '@lanshi17/dsh-session-title'
import type { SessionTitleSnapshot } from '@lanshi17/dsh-session-title'
import type {
