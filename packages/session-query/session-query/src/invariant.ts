/**
 * Package-owned invariant companion for `@lanshi17/dsh-session-query`.
 * @module @lanshi17/dsh-session-query/invariant
 */
...
const PACKAGE_NAME = '@lanshi17/dsh-session-query'
