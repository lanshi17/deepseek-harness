/** Package-owned goal-round prompt invariants. @module @lanshi17/dsh-goal-round-driver/invariant */

import { isDeepStrictEqual } from 'node:util'
import type { Context } from '@lanshi17/cordis'
import { foldGoal, type FoldedGoal, type GoalMessageSource, type GoalView } from '@lanshi17/dsh-goal'
...
const PACKAGE_NAME = '@lanshi17/dsh-goal-round-driver'
