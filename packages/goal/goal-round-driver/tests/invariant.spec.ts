...
import * as GoalSessionInvariant from '@lanshi17/dsh-goal-round-driver/invariant'
import { renderGoalRoundPrompt } from '@lanshi17/dsh-goal-round-driver'
import InvariantRegistry, { InvariantError } from '@lanshi17/dsh-invariants'
import SessionStore, { SessionId, type Session } from '@lanshi17/dsh-session'
...
describe('goal-round-driver prompt invariants', () => {
  ...
  it('rejects a continuation whose content differs from the package renderer', async () => {
    ...
    expect(() => {
      ...
      code: 'INVARIANT',
      packageName: '@lanshi17/dsh-goal-round-driver',
    }))
  })
