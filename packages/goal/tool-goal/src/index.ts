 ...
 * @module @lanshi17/dsh-tool-goal
 */

import type { Context } from '@lanshi17/cordis'
import z from '@lanshi17/schemastery'
import { GoalId } from '@lanshi17/dsh-goal'
import type { GoalRef, GoalView } from '@lanshi17/dsh-goal'
import { boundContextSummary, createUserMessage, HarnessError } from '@lanshi17/dsh-llm'
import { defineTool } from '@lanshi17/dsh-tools'
import type { GenericCallView } from '@lanshi17/dsh-tools'
