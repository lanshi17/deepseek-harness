...
import { createUserMessage, HarnessError } from '@lanshi17/dsh-llm'
import SessionStore, { Session, SessionId, type UserMessage } from '@lanshi17/dsh-session'
import GoalService, {
  GoalError,
  GoalId,
  decodeGoalChange,
  foldGoal,
} from '@lanshi17/dsh-goal'
import type { GoalChangeMeta, GoalRef, GoalSnapshotChangeMeta } from '@lanshi17/dsh-goal'
...
function stubAgent(rawId: string, seed?: readonly import('@lanshi17/dsh-session').SessionEvent[]): StubAgent {
