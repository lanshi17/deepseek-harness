/**
 * Package-owned invariant companion for `@lanshi17/dsh-client-ui-cordis`.
 * @module @lanshi17/dsh-client-ui-cordis/invariant
 */
...
const PACKAGE_NAME = '@lanshi17/dsh-client-ui-cordis'
