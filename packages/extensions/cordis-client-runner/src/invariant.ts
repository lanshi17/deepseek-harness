/**
 * Package-owned invariant companion for `@lanshi17/dsh-cordis-client-runner`.
 * @module @lanshi17/dsh-cordis-client-runner/invariant
 */
...
const PACKAGE_NAME = '@lanshi17/dsh-cordis-client-runner'
