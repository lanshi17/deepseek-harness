/**
 * Package-owned invariant companion for `@lanshi17/dsh-cordis-host-runner`.
 * @module @lanshi17/dsh-cordis-host-runner/invariant
 */
...
const PACKAGE_NAME = '@lanshi17/dsh-cordis-host-runner'
