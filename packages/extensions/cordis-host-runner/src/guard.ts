 ...
 * @module @lanshi17/dsh-cordis-host-runner/guard
 */

import { Context } from '@lanshi17/cordis'
import type { Plugin } from '@lanshi17/cordis'
import { scopeOf } from '@lanshi17/dsh-scope'
import { assertSupportedJsonSchema, defineTool } from '@lanshi17/dsh-tools'
...
function sandboxContext(ctx: Context, reportFailure: (error: Error) => void): Context {
  ...
  // (`@lanshi17/dsh-cordis-client-runner`, whose CTX_VERBS names this one its
