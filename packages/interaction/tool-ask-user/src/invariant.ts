/**
 * Package-owned invariant companion for `@lanshi17/dsh-tool-ask-user`.
 * @module @lanshi17/dsh-tool-ask-user/invariant
 */
...
const PACKAGE_NAME = '@lanshi17/dsh-tool-ask-user'
