 ...
 * Concrete
 * providers such as `@lanshi17/dsh-skill-filesystem` decide where skills come
 ...
 *
 * @module @lanshi17/dsh-skill
 */

import { Context, Service } from '@lanshi17/cordis'
import { assertNever } from '@lanshi17/dsh-llm'
import { NamedEntries, ScopedLayers, scopeChainOf, scopeOf } from '@lanshi17/dsh-scope'
import type { ScopeKey, ScopeLayer } from '@lanshi17/dsh-scope'
