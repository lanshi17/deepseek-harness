 ...
 * @module @lanshi17/dsh-llm-deepseek
 */

import type { Context } from '@lanshi17/cordis'
import z from '@lanshi17/schemastery'
import { assertUsableApiKey, LlmError, resolveRetryPolicy, RetryPolicySchema } from '@lanshi17/dsh-llm'
import type { RetryPolicyConfig } from '@lanshi17/dsh-llm'
import { credentialRef } from '@lanshi17/dsh-credentials'
import { launchEnvironmentOf, type LaunchEnvironmentSnapshot } from '@lanshi17/dsh-launch-environment'
import { deepEqualJson, installSettingsSection, settingsNamespace } from '@lanshi17/dsh-settings'
import { MAX_TIMER_DELAY_MS } from '@lanshi17/dsh-timeout'
import { getOrCreateAnonymousUserId, type AnonymousUserId } from '@lanshi17/dsh-anonymous-user-id'
import {
