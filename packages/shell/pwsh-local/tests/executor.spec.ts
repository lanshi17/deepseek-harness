/**
 * Real-process tests for `@lanshi17/dsh-pwsh-local`: the LOCAL subprocess
...
import { PwshLocalExecutor, ENCODING_PREAMBLE, candidatePwshPaths, resolvePwshPath } from '@lanshi17/dsh-pwsh-local'
import LocalSubprocessRuntime from '@lanshi17/dsh-subprocess-local'
import SubprocessRuntime from '@lanshi17/dsh-subprocess'
import type { SubprocessHandle, SubprocessOutputReader, SubprocessSpawnSpec } from '@lanshi17/dsh-subprocess'
import { MAX_TIMER_DELAY_MS } from '@lanshi17/dsh-timeout'
import type { ShellProcess } from '@lanshi17/dsh-shell'
