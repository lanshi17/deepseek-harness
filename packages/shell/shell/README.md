...
| Package | Role |
|---|---|
| `@lanshi17/dsh-shell` (this) | Service Definition: abstract service + vocabulary types |
| `@lanshi17/dsh-bash-local` | Service Provider: local subprocesses |
| `@lanshi17/dsh-bash-sandbox` | Service Provider: `dsh-bash-local`'s mechanics with every spawn confined via [`ctx.sandbox`](../../sandbox/sandbox/), denials reported as result facts |
| `@lanshi17/dsh-tool-bash` | the model-facing tool schemas over `ctx.shell` |
