 ...
 *
 * @module @lanshi17/dsh-tool-bash/render
 */

import type { ShellProcessRead, ShellRunResult, ShellSandboxInfo, CollectedOutput } from '@lanshi17/dsh-shell'
import type { SandboxMode } from '@lanshi17/dsh-sandbox'
import { escalationHintMarker, sandboxDenialMarker } from '@lanshi17/dsh-sandbox'
 ...
 * rendering story, owned by `@lanshi17/dsh-shell` so `dsh-tool-pwsh` reuses
 ...
 */
export { parseExitStatus, type ParsedExitStatus } from '@lanshi17/dsh-shell'
