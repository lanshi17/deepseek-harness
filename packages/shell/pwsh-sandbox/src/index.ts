 ...
 * `@lanshi17/dsh-bash-sandbox`. It wraps the exact local pwsh argv through
 ...
 * renders.
 * @module @lanshi17/dsh-pwsh-sandbox
 */
...
import { SandboxUnavailableError } from '@lanshi17/dsh-sandbox'
import type {
  ConfinedArgv,
  ConfinedSandboxMode,
  RunnerFailureRule,
