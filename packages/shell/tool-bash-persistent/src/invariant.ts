/**
 * Package-owned invariant companion for `@lanshi17/dsh-tool-bash-persistent`.
 * @module @lanshi17/dsh-tool-bash-persistent/invariant
 */
...
const PACKAGE_NAME = '@lanshi17/dsh-tool-bash-persistent'
