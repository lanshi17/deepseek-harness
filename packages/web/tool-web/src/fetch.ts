...
import type { GenericCallView, JsonValue, ToolResult, WebFetchResultView } from '@lanshi17/dsh-tools'
import type { WebFetchBody, WebFetchResult } from '@lanshi17/dsh-web'
 ...
 * `@lanshi17/dsh-tool-call-timeout-policy`, not a model argument.
 *
 ...
 *   `ToolDefinition.timeoutMs` for `@lanshi17/dsh-tool-call-timeout-policy` to enforce.
