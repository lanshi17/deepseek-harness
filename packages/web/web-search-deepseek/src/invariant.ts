/**
 * Package-owned invariant companion for `@lanshi17/dsh-web-search-deepseek`.
 * @module @lanshi17/dsh-web-search-deepseek/invariant
 */
...
const PACKAGE_NAME = '@lanshi17/dsh-web-search-deepseek'
