 ...
 * `@lanshi17/dsh-tool-web`. Requests carry no browser cookies or ambient credentials.
 *
 ...
 * @module @lanshi17/dsh-web-fetch-http/provider
 */

import { WebError } from '@lanshi17/dsh-web'
import type { WebFetchBody, WebFetchProvider, WebFetchRequest, WebFetchResult } from '@lanshi17/dsh-web'
