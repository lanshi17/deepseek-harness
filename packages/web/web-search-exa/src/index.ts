/**
 * `@lanshi17/dsh-web-search-exa`: registers an Exa-backed `WebSearchProvider`
 ...
 * seam's provider registry, exactly as `@lanshi17/dsh-llm-deepseek`
 * registers an adapter into `ctx.llm`. The key is owned by `@lanshi17/dsh-web`.
 *
 * @module @lanshi17/dsh-web-search-exa
 */
...
import type {} from '@lanshi17/dsh-web'
import {
  ExaSearchProvider,
