/**
 * @lanshi17/dsh-headless — one-shot direct Agent driver. The bundle patch
...
import type { ModelSelectionRef } from '@lanshi17/dsh-agent'
import type {} from '@lanshi17/dsh-agent-default-model'
...
import type {} from '@lanshi17/dsh-cmdline'
...
async function run(ctx: Context, task: string, io: HeadlessIo): Promise<void> {
  ...
  // (@lanshi17/dsh-agent-presets README, "Composing a child agent").
