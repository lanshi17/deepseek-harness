/**
 * @lanshi17/dsh-web-app — the browser-surface bundle's runtime glue plugin
...
import { addHarnessSourceSection } from '@lanshi17/dsh-app-boot'
import * as FrontendStatic from '@lanshi17/dsh-host-frontend-static'
import type {} from '@lanshi17/cordis-plugin-loader'
...
function resolveDistIndex(): string {
  ...
  try {
    return require.resolve('@lanshi17/dsh-web-frontend/dist/index.html')
  } catch {
