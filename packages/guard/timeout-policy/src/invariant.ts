/**
 * Package-owned invariant companion for `@lanshi17/dsh-tool-call-timeout-policy`.
 * @module @lanshi17/dsh-tool-call-timeout-policy/invariant
 */
...
const PACKAGE_NAME = '@lanshi17/dsh-tool-call-timeout-policy'
