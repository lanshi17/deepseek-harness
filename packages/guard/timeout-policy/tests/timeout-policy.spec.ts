/**
 * Unit + real-load-path coverage for @lanshi17/dsh-tool-call-timeout-policy. The
...
import ToolRuntime, { defineContentToolFixture, TOOL_ABORTED, type ToolExecutionInput, type PostToolDecision } from '@lanshi17/dsh-tools'
import * as timeoutPolicy from '@lanshi17/dsh-tool-call-timeout-policy'
import { TOOL_TIMEOUT } from '@lanshi17/dsh-tool-call-timeout-policy'
