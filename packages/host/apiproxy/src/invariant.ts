/**
 * Package-owned invariant companion for `@lanshi17/dsh-host-apiproxy`.
 * @module @lanshi17/dsh-host-apiproxy/invariant
 */
...
const PACKAGE_NAME = '@lanshi17/dsh-host-apiproxy'
