...
import type { AskUserQuestionItem } from '@lanshi17/dsh-user-questions/types'
import type { ApprovalOutcome, ApprovalRequestId } from '@lanshi17/dsh-user-approval/types'
import type { Message } from '@lanshi17/dsh-llm/types'
import type { MessageId } from '@lanshi17/dsh-llm/brand'
import type { CallId } from '@lanshi17/dsh-llm/brand'
import type { JsonValue, SessionEvent, SessionId } from '@lanshi17/dsh-session/types'
import type { ToolCallView, ToolResultView } from '@lanshi17/dsh-tools/presentation'
...
export type { ToolCallView, ToolResultView } from '@lanshi17/dsh-tools/presentation'
...
export type HostFrame =
   ...
   * owned by `@lanshi17/dsh-api-remotes` (`API_REMOTE_FORWARDED_EVENTS`),
