...
import type { AttachmentIdType, ImageAttachmentLimits, ImageAttachmentRef, ImageMediaType } from '@lanshi17/dsh-attachment'
import type { ContentBlock } from '@lanshi17/dsh-llm/types'
import type { SessionEvent, SessionId } from '@lanshi17/dsh-session/types'
// The pure-type outlet: api/ is browser-importable, and the package root's
// cordis Context merge (via dsh-agent) must not enter client aggregates.
import type { SessionProjectionMap } from '@lanshi17/dsh-session-projection/types'
...
declare module '@lanshi17/dsh-llm' {
