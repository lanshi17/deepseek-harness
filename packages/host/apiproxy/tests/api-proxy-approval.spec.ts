...
import type { ApprovalRequestId } from '@lanshi17/dsh-user-approval'
import type { ApiProxy, MuxFrame, RpcRequest } from '@lanshi17/dsh-host-apiproxy/api'
import type { RpcId } from '@lanshi17/dsh-host-apiproxy/api/rpc'
import { RpcId as mintRpcId } from '@lanshi17/dsh-host-apiproxy/api/rpc'
