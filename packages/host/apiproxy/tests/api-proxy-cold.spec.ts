...
import { TypertLookupFailure } from '@lanshi17/dsh-typert-protocol'
import TypertRegistry from '@lanshi17/dsh-typert-registry'
import { createUserMessage, MessageId } from '@lanshi17/dsh-llm'
import type { Agent } from '@lanshi17/dsh-agent'
import UserQuestionService from '@lanshi17/dsh-user-questions'
import type { SessionEvent, SessionHeader, SessionId } from '@lanshi17/dsh-session'
import {
  PersistenceCoordinator,
  SessionPersistenceRevision,
  type PersistenceBackend,
  type StoredPrefix,
} from '@lanshi17/dsh-session-persistence'
import type { RpcRequest } from '@lanshi17/dsh-host-apiproxy/api/rpc'
...
describe('Remote Agent and Session lookup policy', () => {
  it('deduplicates a cold resume across Agent and Session parameters', async () => {
    ...
    const resumedSession = { id: sessionId, header: meta, events: [] } as unknown as import('@lanshi17/dsh-session').Session
