...
import type { Agent, AgentFactory } from '@lanshi17/dsh-agent'
...
import type { DirectoryPickerCapability } from '@lanshi17/dsh-host-directory-picker'
import WorkspaceRegistry from '@lanshi17/dsh-workspace'
import type { HostFrame, WorkspaceId } from '@lanshi17/dsh-host-apiproxy/api'
import type { RpcRequest, RpcResponse } from '@lanshi17/dsh-host-apiproxy/api/rpc'
