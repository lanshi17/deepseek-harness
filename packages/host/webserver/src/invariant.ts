/**
 * Package-owned invariant companion for `@lanshi17/dsh-host-webserver`.
 * @module @lanshi17/dsh-host-webserver/invariant
 */
...
const PACKAGE_NAME = '@lanshi17/dsh-host-webserver'
