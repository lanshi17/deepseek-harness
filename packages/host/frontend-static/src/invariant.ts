/**
 * Package-owned invariant companion for `@lanshi17/dsh-host-frontend-static`.
 * @module @lanshi17/dsh-host-frontend-static/invariant
 */

import type { Context } from '@lanshi17/cordis'
import type { InvariantInstaller } from '@lanshi17/dsh-invariants'

const PACKAGE_NAME = '@lanshi17/dsh-host-frontend-static'
