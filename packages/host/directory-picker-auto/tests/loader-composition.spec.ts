...
import HttpServer from '@lanshi17/dsh-host-webserver'
import type { DirectoryPicker } from '@lanshi17/dsh-host-directory-picker'
import BrowseDirectoryPicker from '@lanshi17/dsh-host-directory-picker-browse'
import NativeDirectoryPicker from '@lanshi17/dsh-host-directory-picker-native'
...
const AUTO = '@lanshi17/dsh-host-directory-picker-auto'
const NATIVE = '@lanshi17/dsh-host-directory-picker-native'
const BROWSE = '@lanshi17/dsh-host-directory-picker-browse'
const NATIVE_SURFACE = '@lanshi17/dsh-client-ui-directory-picker-native'
const BROWSE_SURFACE = '@lanshi17/dsh-client-ui-directory-picker-browse'
...
async function loadComposition(
  ...
  const modules = new Map<string, unknown>([
    ['@lanshi17/dsh-host-webserver', HttpServer],
