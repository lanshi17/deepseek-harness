 ...
 * @module @lanshi17/dsh-host-directory-picker-auto
 */
...
export const BACKEND_PACKAGES: Record<DirectoryPickerBackendKind, string> = {
  native: '@lanshi17/dsh-host-directory-picker-native',
  browse: '@lanshi17/dsh-host-directory-picker-browse',
}
...
export const SURFACE_PACKAGES: Record<DirectoryPickerBackendKind, string> = {
  native: '@lanshi17/dsh-client-ui-directory-picker-native',
  browse: '@lanshi17/dsh-client-ui-directory-picker-browse',
}
