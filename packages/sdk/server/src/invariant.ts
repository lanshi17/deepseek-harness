/**
 * Package-owned invariant companion for `@lanshi17/dsh-sdk-jsonrpc-server`.
 * @module @lanshi17/dsh-sdk-jsonrpc-server/invariant
 */
...
const PACKAGE_NAME = '@lanshi17/dsh-sdk-jsonrpc-server'
