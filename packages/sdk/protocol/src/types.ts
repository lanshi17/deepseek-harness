 ...
 * plugin (`@lanshi17/dsh-sdk-jsonrpc-server`) and SDK clients share these shapes;
 * `serverInfo.name` stays the wire-stable `deepseek-harness-sdk-runtime`.
 *
 * @module @lanshi17/dsh-sdk-protocol/types
 */

import type { ContentBlock } from '@lanshi17/dsh-llm'
import type { SessionEvent } from '@lanshi17/dsh-session'
import type { SubagentStopReason } from '@lanshi17/dsh-subagent'
