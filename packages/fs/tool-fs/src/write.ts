 ...
 * @module @lanshi17/dsh-tool-fs/src/write
 */

import type { Context } from '@lanshi17/cordis'
import { defineTool } from '@lanshi17/dsh-tools'
import type { DiffCallView, DiffResultView, ToolResult } from '@lanshi17/dsh-tools'
import type { FsWriteOutcome } from '@lanshi17/dsh-fs'
