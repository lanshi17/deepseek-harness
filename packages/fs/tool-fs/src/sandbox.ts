 ...
 * sequence to `@lanshi17/dsh-sandbox` (the same pieces `@lanshi17/dsh-tool-bash`
 ...
 *
 * @module @lanshi17/dsh-tool-fs/sandbox
 */
...
import { ESCALATION_TARGETS, approveEscalation, escalationHintMarker, sandboxDenialMarker, validateEscalationArgs } from '@lanshi17/dsh-sandbox'
