 ...
 *
 * @module @lanshi17/dsh-tool-fs-search/search-core
 */

import { isAbsolute, relative, sep } from 'node:path'
import type { Context } from '@lanshi17/cordis'
import { HarnessError } from '@lanshi17/dsh-llm'
import { ItemRetainer, TextRetainer } from '@lanshi17/dsh-output-retention'
import type { RetainedItems } from '@lanshi17/dsh-output-retention'
import type { SubprocessHandle, SubprocessOutcome, SubprocessOutputRead, SubprocessSpawnSpec } from '@lanshi17/dsh-subprocess'
import type { SaveTextSpill, SpillRef } from '@lanshi17/dsh-spill'
 ...
 * `@lanshi17/dsh-tool-call-timeout-policy` to enforce through `exec.signal`.
 */
 ...
 * (`@lanshi17/dsh-tool-call-timeout-policy`) and caller cancellation terminate the
 * process tree.
 *
 ...
 * retention pass both the model-facing render ({@link module:@lanshi17/dsh-tool-fs-search/grep}
 * `formatGrepOutput`) and the search-card projection
 * ({@link module:@lanshi17/dsh-tool-fs-search/presentation} `grepSearchMeta`)
