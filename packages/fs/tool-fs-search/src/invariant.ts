/**
 * Package-owned invariant companion for `@lanshi17/dsh-tool-fs-search`.
 * @module @lanshi17/dsh-tool-fs-search/invariant
 */
...
const PACKAGE_NAME = '@lanshi17/dsh-tool-fs-search'
