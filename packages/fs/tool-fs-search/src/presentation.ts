 ...
 * model-facing render consumes ({@link module:@lanshi17/dsh-tool-fs-search/search-core}
 ...
 *
 * @module @lanshi17/dsh-tool-fs-search/presentation
 */
 ...
 * ({@link module:@lanshi17/dsh-tool-fs-search/grep} `formatGrepMatches`), so
