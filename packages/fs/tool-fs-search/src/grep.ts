 ...
 *
 * @module @lanshi17/dsh-tool-fs-search/grep
 */

import type { Context } from '@lanshi17/cordis'
import { defineTool } from '@lanshi17/dsh-tools'
import type { GenericCallView, SearchResultView, ToolResult } from '@lanshi17/dsh-tools'
import type { RetainedItems } from '@lanshi17/dsh-output-retention'
import type { SpillRef } from '@lanshi17/dsh-spill'
