 ...
 * `@lanshi17/dsh-fs` Service Definition. It extends `LocalFileSystem` so all
 ...
 * stays `ctx.shell`'s job (`@lanshi17/dsh-bash-sandbox`). This mirrors the
 ...
 * escalation retry lives in the tool layer (`@lanshi17/dsh-tool-fs`),
 * exactly as bash's does.
 *
 * @module @lanshi17/dsh-fs-sandbox
 */

import { Context } from '@lanshi17/cordis'
import { LocalFileSystem } from '@lanshi17/dsh-fs-local'
import type { Config as LocalConfig } from '@lanshi17/dsh-fs-local'
import { FsError } from '@lanshi17/dsh-fs'
import type { FsEditOutcome, FsEditRequest, FsTarget, FsVersion, FsWriteIntent, FsWriteOutcome } from '@lanshi17/dsh-fs'
import { writableRoots } from '@lanshi17/dsh-sandbox'
