/**
 * Package-owned invariant companion for `@lanshi17/dsh-tool-str-replace-editor`.
 * @module @lanshi17/dsh-tool-str-replace-editor/invariant
 */
...
const PACKAGE_NAME = '@lanshi17/dsh-tool-str-replace-editor'
