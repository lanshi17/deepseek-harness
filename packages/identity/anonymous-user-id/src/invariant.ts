/**
 * Package-owned invariant companion for `@lanshi17/dsh-anonymous-user-id`.
 * @module @lanshi17/dsh-anonymous-user-id/invariant
 */
...
const PACKAGE_NAME = '@lanshi17/dsh-anonymous-user-id'
