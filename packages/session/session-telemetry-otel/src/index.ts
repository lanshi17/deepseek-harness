 ...
 *
 * @module @lanshi17/dsh-session-telemetry-otel
 */

import { createRequire } from 'node:module'
import z from '@lanshi17/schemastery'
import type { Context } from '@lanshi17/cordis'
import type {} from '@lanshi17/dsh-command-feedback'
import {
...
} from '@lanshi17/dsh-session-telemetry'
import { APP_IDENTITY } from '@lanshi17/dsh-llm'
...
export class OpenTelemetrySessionBackend extends SessionTelemetryBackend {
  ...
  constructor(ctx: Context, config: Config) {
    ...
    const ledger = this.provider.getLogger('@lanshi17/dsh-session-telemetry-otel', version)
    const ops = this.provider.getLogger('@lanshi17/dsh-session-telemetry-otel/ops', version)
