/**
 * Package-owned invariant companion for `@lanshi17/dsh-session-telemetry-otel`.
 * @module @lanshi17/dsh-session-telemetry-otel/invariant
 */
...
const PACKAGE_NAME = '@lanshi17/dsh-session-telemetry-otel'
