/**
 * Package-owned invariant companion for `@lanshi17/dsh-session-title-first-prompt-llm`.
 * @module @lanshi17/dsh-session-title-first-prompt-llm/invariant
 */
...
const PACKAGE_NAME = '@lanshi17/dsh-session-title-first-prompt-llm'
