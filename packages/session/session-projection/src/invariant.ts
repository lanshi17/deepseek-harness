/**
 * Package-owned invariant companion for `@lanshi17/dsh-session-projection`.
 * @module @lanshi17/dsh-session-projection/invariant
 */
...
const PACKAGE_NAME = '@lanshi17/dsh-session-projection'
