/**
 * Package-owned invariant companion for `@lanshi17/dsh-session-title-llm`.
 * @module @lanshi17/dsh-session-title-llm/invariant
 */
...
const PACKAGE_NAME = '@lanshi17/dsh-session-title-llm'
