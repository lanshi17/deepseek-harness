 ...
 * @module @lanshi17/dsh-session-title-llm
 */

import type { Context } from '@lanshi17/cordis'
import z from '@lanshi17/schemastery'
import { createUserMessage, BlockAssembler, deepFreeze } from '@lanshi17/dsh-llm'
import type { FinishReason, GenerateOptions, Message } from '@lanshi17/dsh-llm'
import { deadline, MAX_TIMER_DELAY_MS } from '@lanshi17/dsh-timeout'
import {
  normalizeSessionTitle,
  SessionTitleProviderId,
} from '@lanshi17/dsh-session-title'
import type {
