 ...
 * @module @lanshi17/dsh-session-persistence
 */

import { Context, Service } from '@lanshi17/cordis'
import { SessionPreparation } from '@lanshi17/dsh-session'
import type { SessionEvent, SessionId, SessionHeader } from '@lanshi17/dsh-session'
import type { SessionPersistenceRevision } from './revision.ts'

// Re-export the metadata vocabulary so Consumers import it from the Service Definition.
export type { SessionHeader } from '@lanshi17/dsh-session'
