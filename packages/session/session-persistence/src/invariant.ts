/**
 * Package-owned invariant companion for `@lanshi17/dsh-session-persistence`.
 * @module @lanshi17/dsh-session-persistence/invariant
 */
...
const PACKAGE_NAME = '@lanshi17/dsh-session-persistence'
