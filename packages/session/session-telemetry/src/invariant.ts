/**
 * Package-owned invariant companion for `@lanshi17/dsh-session-telemetry`.
 * @module @lanshi17/dsh-session-telemetry/invariant
 */
...
const PACKAGE_NAME = '@lanshi17/dsh-session-telemetry'
