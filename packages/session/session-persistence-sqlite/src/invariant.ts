/**
 * Package-owned invariant companion for `@lanshi17/dsh-session-persistence-sqlite`.
 * @module @lanshi17/dsh-session-persistence-sqlite/invariant
 */
...
const PACKAGE_NAME = '@lanshi17/dsh-session-persistence-sqlite'
