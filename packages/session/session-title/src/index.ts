 ...
 * @module @lanshi17/dsh-session-title
 */

import { Context, FiberState, Service, type Fiber } from '@lanshi17/cordis'
import z from '@lanshi17/schemastery'
import { z as zod } from 'zod'
import type { Branded } from '@lanshi17/dsh-brand'
import { assertNever, deepFreeze, isAgentLoopRequest } from '@lanshi17/dsh-llm'
import type { GenerateOptions } from '@lanshi17/dsh-llm'
import type {
  Session,
  SessionEvent,
