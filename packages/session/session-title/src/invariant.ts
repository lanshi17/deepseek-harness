/**
 * Package-owned invariant companion for `@lanshi17/dsh-session-title`.
 * @module @lanshi17/dsh-session-title/invariant
 */
...
const PACKAGE_NAME = '@lanshi17/dsh-session-title'
