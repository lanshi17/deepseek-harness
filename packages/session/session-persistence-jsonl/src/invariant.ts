/**
 * Package-owned invariant companion for `@lanshi17/dsh-session-persistence-jsonl`.
 * @module @lanshi17/dsh-session-persistence-jsonl/invariant
 */
...
const PACKAGE_NAME = '@lanshi17/dsh-session-persistence-jsonl'
