/**
 * Package-owned invariant companion for `@lanshi17/dsh-session-stats`.
 * @module @lanshi17/dsh-session-stats/invariant
 */
...
const PACKAGE_NAME = '@lanshi17/dsh-session-stats'
