/**
 * Package-owned invariant companion for `@lanshi17/dsh-session-projection-cache`.
 * @module @lanshi17/dsh-session-projection-cache/invariant
 */
...
const PACKAGE_NAME = '@lanshi17/dsh-session-projection-cache'
