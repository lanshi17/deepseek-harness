/**
 * Package-owned invariant companion for `@lanshi17/dsh-jobs-local`.
 * @module @lanshi17/dsh-jobs-local/invariant
 */
...
const PACKAGE_NAME = '@lanshi17/dsh-jobs-local'
...
/**
 * No runtime invariant: `@lanshi17/dsh-jobs/invariant` owns per-snapshot identity, status,
