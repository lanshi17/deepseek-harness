 ...
 * @module @lanshi17/dsh-tool-jobs
 */

import type { Context } from '@lanshi17/cordis'
import z from '@lanshi17/schemastery'
import { boundContextSummary, createUserMessage, type ContentBlock } from '@lanshi17/dsh-llm'
import { TextRetainer } from '@lanshi17/dsh-output-retention'
import { defineTool } from '@lanshi17/dsh-tools'
import type { GenericCallView, ToolDefinition, ToolExecution } from '@lanshi17/dsh-tools'
