/**
 * Package-owned invariant companion for `@lanshi17/dsh-sandbox-windows-acl`.
 * @module @lanshi17/dsh-sandbox-windows-acl/invariant
 */
...
const PACKAGE_NAME = '@lanshi17/dsh-sandbox-windows-acl'
