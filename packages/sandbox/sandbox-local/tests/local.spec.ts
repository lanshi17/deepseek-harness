...
import { LAUNCHER_FAILURE_EXIT } from '@lanshi17/node-addon-landlock-run'
import { SANDBOX_UNAVAILABLE, SandboxUnavailableError } from '@lanshi17/dsh-sandbox'
import type { SandboxPolicy } from '@lanshi17/dsh-sandbox'
import {
  LocalSandboxProvider,
} from '@lanshi17/dsh-sandbox-local'
import type { Config } from '@lanshi17/dsh-sandbox-local'
...
describe('the platform chains', () => {
  ...
  // live in @lanshi17/dsh-sandbox-windows-acl/tests/provider-chain.spec.ts
