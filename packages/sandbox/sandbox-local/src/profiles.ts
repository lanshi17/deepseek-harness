 ...
 *
 * @module @lanshi17/dsh-sandbox-local/profiles
 */

import { grantArgs as landlockGrantArgs } from '@lanshi17/node-addon-landlock-run'
 ...
 * (`@lanshi17/dsh-fs-sandbox`) can never drift apart.
