/**
 * Package-owned invariant companion for `@lanshi17/dsh-subprocess-e2b`.
 * @module @lanshi17/dsh-subprocess-e2b/invariant
 */
...
const PACKAGE_NAME = '@lanshi17/dsh-subprocess-e2b'
