 ...
 * turn/step boundaries remain `@lanshi17/dsh-session` events.
 *
 * @module @lanshi17/dsh-agent
 */

import type { Context } from '@lanshi17/cordis'
import type { Scoped } from '@lanshi17/dsh-scope'
import type { LlmCallConfig, LlmFailure, ResolvedRetryPolicy } from '@lanshi17/dsh-llm'
import type { AgentCancelCause, Session, SessionId, UserMessage } from '@lanshi17/dsh-session'
export type { AgentCancelCause } from '@lanshi17/dsh-session'
import type { Inbox } from './inbox.ts'
import type { InboxTarget } from './types.ts'
import type {} from '@lanshi17/dsh-system-prompt'
declare module '@lanshi17/dsh-system-prompt' {
...
declare module '@lanshi17/cordis' {
  interface Events {
     ...
     * Scope-filtered dispatch (`@lanshi17/dsh-scope`): agent-scoped listeners receive only that agent.
     * @mode emit
     */
