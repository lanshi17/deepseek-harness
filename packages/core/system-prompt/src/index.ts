 ...
 *
 * @module @lanshi17/dsh-system-prompt
 */

import { Context, Service } from '@lanshi17/cordis'
import z from '@lanshi17/schemastery'
import { AnonymousEntries, NamedEntries, ScopedLayers, scopeTarget } from '@lanshi17/dsh-scope'
import type { ScopeKey, ScopeLayer, Scoped } from '@lanshi17/dsh-scope'
import type { ContextSnapshotSection, ToolSchema } from '@lanshi17/dsh-llm'
...
declare module '@lanshi17/cordis' {
  ...
  interface Events {
     ...
     * Scope-filtered dispatch (`@lanshi17/dsh-scope`): scoped listeners
