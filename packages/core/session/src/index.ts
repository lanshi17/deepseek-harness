 ...
 *
 * @module @lanshi17/dsh-session
 */

import { Context, Service } from '@lanshi17/cordis'
import { isAbsolute } from 'node:path'
import { deepFreeze } from '@lanshi17/dsh-llm'
import { scopeOf, scopeTarget } from '@lanshi17/dsh-scope'
import type { Scoped } from '@lanshi17/dsh-scope'
import type { Message } from '@lanshi17/dsh-llm'
import { SESSION_FORMAT_VERSION, SessionId } from './types.ts'
import type { TypertLookup } from '@lanshi17/dsh-typert-protocol'
...
export type { AssistantMessage, ToolResultMessage, UserMessage } from '@lanshi17/dsh-llm'
  ...
  constructor(ctx: Context) {
    ...
    ctx.inject(['typert'], (typeCtx) => {
      typeCtx.typert.lookups.register('session', {
        parameter: 'session',
        wire: 'sessionId',
        hostTypeSymbol: '@lanshi17/dsh-session#Session',
        wireTypeSymbol: '@lanshi17/dsh-session/types#SessionId',
