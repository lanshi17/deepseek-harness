/** Package-owned scoped-dispatch invariants. @module @lanshi17/dsh-scope/invariant */

import type { Context } from '@lanshi17/cordis'
import type { InvariantInstaller } from '@lanshi17/dsh-invariants'
import { carrierKeyOf, isScopeCarrier } from '@lanshi17/dsh-scope'
import { scopedSubjectResolverFor } from './scoped-events.generated.ts'

const PACKAGE_NAME = '@lanshi17/dsh-scope'
