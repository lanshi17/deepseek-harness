 ...
 * @module @lanshi17/dsh-agent-loop/runtime-context
 */

import { createUserMessage } from '@lanshi17/dsh-llm'
import type { ContextSnapshotSection } from '@lanshi17/dsh-llm'
import type { Session, UserMessage } from '@lanshi17/dsh-session'
import { isReplacementSurfaceEvent } from '@lanshi17/dsh-session'
import type { Context } from '@lanshi17/cordis'

const SOURCE = '@lanshi17/dsh-system-prompt'
