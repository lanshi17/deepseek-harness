...
import { bindScopeParent, createScope } from '@lanshi17/dsh-scope'
...
import type { PreToolDecision, ToolDefinition, ToolExecution, ToolExecutionInput, ToolExecutionToken } from '@lanshi17/dsh-tools'
