...
import { createUserMessage, CallId, HarnessError, type ContentBlock  } from '@lanshi17/dsh-llm'
import SystemPrompt from '@lanshi17/dsh-system-prompt'
import type { Agent } from '@lanshi17/dsh-agent'
import ApprovalService, { type ApprovalOutcome, type ApprovalRequest } from '@lanshi17/dsh-user-approval'
import ToolRuntime, {
