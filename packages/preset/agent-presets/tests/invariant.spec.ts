...
import AgentRegistry, { assembleContextFor } from '@lanshi17/dsh-agent'
import AgentLoop from '@lanshi17/dsh-agent-loop'
import InvariantRegistry from '@lanshi17/dsh-invariants'
import { describe, expect, it } from 'vitest'
import AgentPresets, { livePresetMounts, type Config } from '@lanshi17/dsh-agent-presets'
import * as AgentPresetsInvariant from '@lanshi17/dsh-agent-presets/invariant'
