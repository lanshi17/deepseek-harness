 ...
 * @module @lanshi17/dsh-agent-presets
 */

import { stat } from 'node:fs/promises'
import { Context, Service } from '@lanshi17/cordis'
import z from '@lanshi17/schemastery'
import { bindScopeParent, createScope, scopeOf, type Scope, type ScopeKey, type ScopeParentBinding } from '@lanshi17/dsh-scope'
// Type-only: resolves the `agent/created` lifecycle event this service watches.
import type {} from '@lanshi17/dsh-agent'
import { settingsNamespace, type SettingsScope, type default as SettingsService } from '@lanshi17/dsh-settings'
