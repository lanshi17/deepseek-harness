 ...
 * @module @lanshi17/dsh-agent-presets/mount
 */
...
import type { EntryTree } from '@lanshi17/cordis-plugin-loader'
import { scopeOf, scopeParentOf, type ScopeKey } from '@lanshi17/dsh-scope'
...
class PresetTree extends Include {
   ...
   * dependencies, so every `@lanshi17/dsh-*` row would fail to import. The
