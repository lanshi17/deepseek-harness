/**
 * Package-owned invariant companion for `@lanshi17/dsh-agent-presets`.
 * @module @lanshi17/dsh-agent-presets/invariant
 */
...
import { leakedServices, livePresetMounts } from '@lanshi17/dsh-agent-presets'

const PACKAGE_NAME = '@lanshi17/dsh-agent-presets'
