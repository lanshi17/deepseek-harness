/**
 * Package-owned invariant companion for `@lanshi17/dsh-hooks-claude-code`.
 * @module @lanshi17/dsh-hooks-claude-code/invariant
 */
...
const PACKAGE_NAME = '@lanshi17/dsh-hooks-claude-code'
