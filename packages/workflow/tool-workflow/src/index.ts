 ...
 * (`@lanshi17/dsh-workflow`), so a hardened engine swaps in without touching what the model
 ...
 * @module @lanshi17/dsh-tool-workflow
 */

import type { Context } from '@lanshi17/cordis'
import z from '@lanshi17/schemastery'
import { defineTool } from '@lanshi17/dsh-tools'
import type { ToolCallView, ToolResultView } from '@lanshi17/dsh-tools'
import type { ContentBlock } from '@lanshi17/dsh-llm'
import type { JsonValue, Session, SessionEventMap } from '@lanshi17/dsh-session'
import type {
