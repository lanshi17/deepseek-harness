 ...
 * @module @lanshi17/dsh-workflow-worker-thread/runtime
 */

import * as vm from 'node:vm'
import type { ContentBlock } from '@lanshi17/dsh-llm'
import { SessionId } from '@lanshi17/dsh-session'
import { assertObjectJsonSchema, JsonSchemaError } from '@lanshi17/dsh-tools'
import type { ObjectJsonSchema } from '@lanshi17/dsh-tools'
import { isFatalWorkflowError, WorkflowError } from '@lanshi17/dsh-workflow'
import type {
