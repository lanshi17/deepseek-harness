/**
 * Package-owned invariant companion for `@lanshi17/dsh-workflow-worker-thread`.
 * @module @lanshi17/dsh-workflow-worker-thread/invariant
 */
...
const PACKAGE_NAME = '@lanshi17/dsh-workflow-worker-thread'
