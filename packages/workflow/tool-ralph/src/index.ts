 ...
 * @module @lanshi17/dsh-tool-ralph
 */
...
import type { SubagentProvider } from '@lanshi17/dsh-subagent'
import { defineTool } from '@lanshi17/dsh-tools'
import type { ToolCallView, ToolResultView } from '@lanshi17/dsh-tools'
import type { WorkflowResult, WorkflowRun } from '@lanshi17/dsh-workflow'
