/**
 * Package-owned invariant companion for `@lanshi17/dsh-session-reference`.
 * @module @lanshi17/dsh-session-reference/invariant
 */
...
const PACKAGE_NAME = '@lanshi17/dsh-session-reference'
