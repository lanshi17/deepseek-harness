...
import { boot, healProfilesModuleFallback, loadOverlayPatches } from '@lanshi17/dsh-app-boot'
...
import type { PatchOptions } from '@lanshi17/cordis-plugin-include'
import { afterAll, beforeAll, describe, expect, it } from 'vitest'
import { settingsNamespace } from '@lanshi17/dsh-settings'
import { resolveSessionPreset, SETTINGS_NAMESPACE } from '@lanshi17/dsh-agent-presets'
import { applyChildComposition, childSessionMeta } from '@lanshi17/dsh-subagent'
import { CallId } from '@lanshi17/dsh-llm'
import type {} from '@lanshi17/dsh-compaction-basic'
...
import type {} from '@lanshi17/dsh-token-meter'
...
describe('product subagent rows in user presets', () => {
  ...
  beforeAll(async () => {
    ...
    productCtx = await bootWeb(settingsFile, [
      { insert: [
        { id: 'subagent-codex', name: '@lanshi17/dsh-subagent-codex' },
        { id: 'subagent-claude-code', name: '@lanshi17/dsh-subagent-claude-code' },
      ] },
      {
        id: 'agent-presets',
        config: {
