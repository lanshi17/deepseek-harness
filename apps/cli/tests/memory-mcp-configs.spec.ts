...
import { boot, loadOverlayPatches } from '@lanshi17/dsh-app-boot'
import SystemPrompt from '@lanshi17/dsh-system-prompt'
import ToolRuntime from '@lanshi17/dsh-tools'
import * as McpClient from '@lanshi17/dsh-mcp-client/src/index.ts'
...
describe('third-party memory MCP example overlays', () => {
  it.each(examples)('parses $file with the documented generic plugin fields', (contract) => {
    ...
    expect(row.name).toBe('@lanshi17/dsh-mcp-client')
