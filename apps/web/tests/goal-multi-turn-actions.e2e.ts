...
import { parseSessionLog } from '@lanshi17/dsh-llm-replay'
import type { SessionEvent, SessionId } from '@lanshi17/dsh-session'
import type {} from '@lanshi17/dsh-goal'
import {
...
const PACKAGE_FILES: Readonly<Record<string, string>> = {
  ...
  'packages/client/ui-conversation/package.json': '{"name":"@lanshi17/dsh-client-ui-conversation"}\n',
  ...
  'packages/context/session-reference/package.json': '{"name":"@lanshi17/dsh-session-reference"}\n',
  ...
  'packages/llm/token-meter/package.json': '{"name":"@lanshi17/dsh-token-meter"}\n',
  ...
  'packages/skill/skill-filesystem/package.json': '{"name":"@lanshi17/dsh-skill-filesystem"}\n',
